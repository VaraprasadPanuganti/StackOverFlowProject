...
namespace ServiceLayer
{
    ...
    public class AnswersService : IAnswersService
    {
        ...
        //public AnswersService(StackOverflowDbContext _db)
        //{
        //    ar = new AnswersRepository(_db);
        //}
        private readonly IAnswersRepository ar;

        public AnswersService(IAnswersRepository _ar)
        {
